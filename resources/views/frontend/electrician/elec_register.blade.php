       ...
       <form action="{{ route('electrician.store') }}" method="post" enctype="multipart/form-data">
        @csrf
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Electrician Register</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="form-group col-lg-12">
                      <label for="exampleInputEmail1">Nid Number <span class="text-danger">*</span> </label>
          ...
          <div class="col-md-4">
           ...
           <button class="btn btn-info ml-2" type="submit"> {{ __('Register') }}</button>
         </div>
        </form>
      </div><!-- /.container-fluid -->
    </section>
