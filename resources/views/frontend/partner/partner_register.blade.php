...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Partner Register') }}</div>

                <div class="card-body"> 
                    <form method="POST" action="{{ route('store.partner') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Nid Number') }}</label>
